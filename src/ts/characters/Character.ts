...
export class Character extends THREE.Object3D implements IWorldEntity
{
	...
	public rayCastLength: number = 1.2;
	...
	constructor(gltf: any)
	{
		...
		// this.rotationSimulator = new RelativeSpringSimulator(360, this.defaultRotationSimulatorMass, this.defaultRotationSimulatorDamping);
		...
		this.characterCapsule.body.fixedRotation = false;
